...
export const metadata: Metadata = {
  title: 'Static Pass Box Straight Doors | Accumax India',
  description:
    'Static Pass Box systems by Accumax India designed for material transfer in cleanroom environments.',
};
...
export default function StaticStraightDoor() {
        ...
        <section className={styles.hero}>
          ...
          <div className={styles.heroInner}>
            ...
            <div className={styles.imageWrap}>
              ...
              <img
                src="/assets/products/StaticStraightEntry.jpeg"
                alt="Static Pass Box Straight Doors"
            ...
            <div className={styles.heroContent}>
              ...
              <h1 className={styles.title}>
                Static Pass Box Straight Doors
              </h1>

              <p className={styles.lead}>
                Static Pass Boxes are specially designed for safe and efficient
              ...
              <section className={styles.section}>
                ...
                <div className={styles.container}>
                  ...
                  <p className={styles.description}>
                    Accumax India Static Pass Boxes are manufactured using premium
