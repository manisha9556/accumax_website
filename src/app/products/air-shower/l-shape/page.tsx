...
export const metadata: Metadata = {
  title: 'L-Shape Air Shower | Accumax India',
  description:
    'L-Shape Air Shower systems by Accumax India designed for cleanroom contamination control and personnel decontamination.',
};
...
export default function LShapePage() {
  return (
    <>
      <Header />
        ...
        <section className={styles.hero}>
          ...
          <div className={styles.heroInner}>
            <div className={styles.imageWrap}>
              <img
                src="/assets/products/L-Shape.jpeg"
                alt="L-Shape Air Shower"
            ...
            <div className={styles.heroContent}>
              ...
              <p className={styles.lead}>
                L-Shape Air Shower systems are designed to minimize
      ...
      <section className={styles.section}>
        ...
        <div className={styles.container}>
          ...
          <p className={styles.description}>
            Accumax India L-Shape Air Shower units are engineered
