...
export const metadata: Metadata = {
  title: 'Sliding Door Air Shower | Accumax India',
  description:
    'Sliding Door Air Shower systems by Accumax India designed for cleanroom contamination control and personnel decontamination.',
};
...
const specifications = [
  ...
  },
  {
    label: 'Door',
    value:
      'Frame Made of Stainless Steel / Galvanized Iron Powder Coated Interlocking Facility with Half Toughened Glass , Sliding Door',
  },
  {
    label: 'Handle / Hinge',
    value:
  ...
  },
  {
    label: 'Operations',
    value:
      'Automatic Actuation Operation and Adjustable Timer Through Microprocessor Based Controller , Human sensor based operation',
  },
  {
    label: 'Noise Level',
    value:
        ...
        <section className={styles.hero}>
          ...
          <div className={styles.heroInner}>
            <div className={styles.imageWrap}>
              <img
                src="/assets/products/slidingDoor.jpeg"
                alt="Sliding Door Air Shower"
            ...
            <div className={styles.heroContent}>
              ...
              <p className={styles.lead}>
                Sliding Door Air Shower systems are designed to minimize
                contamination by removing dust particles from personnel before
                entering cleanroom environments. These systems ensure superior
                cleanliness standards for pharmaceutical, electronics, food,
      ...
      <section className={styles.section}>
        <div className={styles.container}>
          ...
          <p className={styles.description}>
            Accumax India Sliding Door Air Shower units are engineered
            with precision to maintain cleanroom integrity and reduce
            contamination risks. The system uses high velocity filtered
            air jets to effectively remove dust and particulate matter
            from personnel before entering controlled environments.
          </p>

          <p className={styles.description}>
            Manufactured using premium grade stainless steel and advanced
            HEPA filtration technology, our air shower systems deliver
            reliable performance, operational efficiency, and long-term
