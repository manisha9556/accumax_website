...
export const metadata: Metadata = {
  title: 'Tunnel Air Shower | Accumax India',
  description:
    'Tunnel Air Shower systems by Accumax India designed for cleanroom contamination control and personnel decontamination.',
};
...
const specifications = [
  ...
  },
  {
    label: 'Flooring',
    value:
      'Stainless Steel / Perforted with Tray',
  },
  {
    label: 'Door',
    value:
      'PVC Flap at Entry Exit',
  },
  {
    label: 'Handle / Hinge',
    value:
        ...
        <section className={styles.hero}>
          ...
          <div className={styles.heroInner}>
            <div className={styles.imageWrap}>
              <img
                src="/assets/products/tunnel.jpg"
                alt="Tunnel Air Shower"
            ...
            <div className={styles.heroContent}>
              ...
              <p className={styles.lead}>
                Tunnel Air Shower systems are designed to minimize
      ...
      <section className={styles.section}>
        ...
        <div className={styles.container}>
          ...
          <p className={styles.description}>
            Accumax India Tunnel Air Shower units are engineered
