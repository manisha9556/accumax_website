...
export const metadata: Metadata = {
  title: 'Biosafety Cabinet Class III | Accumax India',
  description:
    'Biosafety Cabinet Class III manufactured by Accumax India for high-level contamination control and laboratory safety.',
};
...
export default function BiosafetyCabinetClassIIIPage() {
        ...
        <section className={styles.hero}>
          ...
          <div className={styles.heroInner}>
            ...
            <div className={styles.imageWrap}>
              ...
              <img
                src="/assets/products/class_III.jpeg"
                alt="Biosafety Cabinet Class III"
              ...
              <section className={styles.section}>
                ...
                <div className={styles.container}>
                  ...
                  <p className={styles.description}>
                    Accumax India Biosafety Cabinets Class III
                    are specially designed to provide superior
                    protection for laboratory personnel,
                    products, and the environment during
                    biological research and testing operations.
                  </p>
