...
export const metadata: Metadata = {
  title: 'Dynamic Garment Storage Cabinet | Accumax India',
  description:
...
const specifications = [
  ...
  },
  {
    label: 'Air Pressure',
    value:
      'Dynamic Manometer / Magnahelic Gauge',
  },
  {
    label: 'Stand',
    value:
...
export default function DynamicGarmentStoragePage() {
        ...
        <section className={styles.hero}>
          ...
          <div className={styles.heroInner}>
            ...
            <div className={styles.imageWrap}>
              ...
              <img
                src="/assets/products/Dynamic_garment_cabinet_storage.jpeg"
                alt="Dynamic Garment Storage Cabinet"
